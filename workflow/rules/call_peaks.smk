rule paralyzer_ini:
    input:
        ...
        sam=lambda: "results/prepare_aligned/{sample}_sorted_deduplicated.sam" if config['UMI-BARCODE'] is not False else "results/prepare_aligned/{sample}_aligned_filtered.sam=COLLAPSED",
